export const publications = [
  ...
  
  {
    ...
    homepage: false,
    authors: "Oskar Elek, Joseph N. Burchett, J. Xavier Prochaska, Angus G. Forbes",
    brief:
  ...
  },
  {
    ...
    homepage: false,
    authors: " Joseph N. Burchett, David Abramov, Oskar Elek, Angus G. Forbes",
    brief:
  ...
  },
  {
    ...
    homepage: true,
    authors: " Joseph N. Burchett, Oskar Elek, Nicolas Tejos, J. Xavier Prochaska, Todd M. Tripp, Rongmon Bordoloi, Angus G. Forbes",
    brief:"Modern cosmology predicts that matter in our Universe has assembled today into a vast network of filamentary structures colloquially termed the Cosmic Web. Because this matter is either electromagnetically invisible (i.e., dark) or too diffuse to image in emission, tests of this cosmic web paradigm are limited. Widefield surveys do reveal web-like structures in the galaxy distribution, but these luminous galaxies represent less than 10% of baryonic matter. Statistics of absorption by the intergalactic medium (IGM) via spectroscopy of distant quasars support the model yet have not conclusively tied the diffuse IGM to the web. "},
  {
    ...
    homepage: false,
    authors: "Sunil Simha, Joseph N. Burchett, J. Xavier Prochaska, Jay S. Chittidi, Oskar Elek, Nicolas Tejos et al.",
    brief:
